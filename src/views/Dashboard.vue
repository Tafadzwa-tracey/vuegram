      ...
      <div class="col2">
        <div v-if="posts.length">
          <div v-for="post in posts" :key="post.id" class="post">
            <h5>{{ post.UserName }}</h5>
            <!-- <span>{{post.createdOn.toDate() | formatDate}}</span> -->
            <span>{{ post.createdOn.toDate() }}</span>
            ...
            <ul>
              ...
              <li>
                <a @click="likePost(post)">likes {{ post.likes }}</a>
              </li>
      ...
      <div v-if="showPostModal" class="p-modal">
        <div class="p-container">
          ...
          <div class="post">
            ...
            <span>{{ fullPost.createdOn.toDate() }}</span>
          ...
          <div v-show="postComments.length" class="comments">
            ...
            >
              ...
              <span>{{ comment.createdOn.toDate() }}</span>
              <p>{{ comment.content }}</p>
            </div>
          </div>
        </div>
